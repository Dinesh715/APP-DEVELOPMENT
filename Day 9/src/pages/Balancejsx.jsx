    ...
    <div>
      ...
      <div className='service'> 
        <div className='serviceimages'>
          <img className='delight1' src={delight}></img>
          <h1>
            <div className='heading'>ISD Delights<p>
              <div className='content'>Explore plans with 
                  ISD calls at lower rates,<br></br> talk-time benefits, FREE SMS, and Top-up <br></br>vouchers.
      ...
      <div className='service'>
        <div className='serviceimages'>
          <img className='delight1' src={flight}></img>
          <h1>
